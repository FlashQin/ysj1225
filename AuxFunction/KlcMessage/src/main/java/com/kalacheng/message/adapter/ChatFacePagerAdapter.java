...
public class ChatFacePagerAdapter extends PagerAdapter {
    ...
    public ChatFacePagerAdapter(Context context,  ChatFaceAdapter.OnFaceClickListener onFaceClickListener) {
        ...
        for (int i = 0; i < pageCount; i++) {
            RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.layout_face_single_page, null, false);
            ...
            list.add("<");
            recyclerView.setAdapter(new ChatFaceAdapter(list, inflater, onFaceClickListener));
