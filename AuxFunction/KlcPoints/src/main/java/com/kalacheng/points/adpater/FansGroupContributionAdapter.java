...
import com.kalacheng.points.databinding.FansRankHeaditemBinding;
import com.kalacheng.util.utils.glide.ImageLoader;

import java.util.ArrayList;
import java.util.List;

public class FansGroupContributionAdapter extends RecyclerView.Adapter {
    ...
    public FansGroupContributionAdapter(Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == HEAD) {
            FansRankHeaditemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.fans_rank_headitem, parent, false);
    ...
    public class ProfitListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProfitListViewHolder(@NonNull ItemFansGroupRankBinding binding) {
        ...
        public void setData(final RanksDto bean, int position) {
            ...
            binding.order.setText("NO. " + (position + 4));
    ...
    public class ProfitListHeadViewHolder extends RecyclerView.ViewHolder {
        FansRankHeaditemBinding headitmeBinding;

        public ProfitListHeadViewHolder(FansRankHeaditemBinding binding) {
            super(binding.getRoot());
