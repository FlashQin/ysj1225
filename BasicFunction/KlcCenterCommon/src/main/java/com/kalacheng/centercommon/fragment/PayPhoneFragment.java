...
public class PayPhoneFragment extends BaseFragment {
    ...
    private void getData(final boolean isfresh) {
        HttpApiAppUser.getContactRecord(30001, pageIndex, HttpConstants.PAGE_SIZE, HttpClient.getUid(), new HttpApiCallBackArr<ChangeDto>() {
            @Override
