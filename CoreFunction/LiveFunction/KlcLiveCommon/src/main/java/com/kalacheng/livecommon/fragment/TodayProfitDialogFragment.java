 ...
 * 今天收益榜
 */
public class TodayProfitDialogFragment extends BaseMVVMFragment<TodayProfitBinding, TodayProfitViewModel> {
    ...
    public void initData() {
        ...
        binding.todayProfitRecy.setLayoutManager(manager);


        adpater= new ProfitAdpater(getActivity());
        binding.todayProfitRecy.setAdapter(adpater);
    ...
    public void getProfit() {
        HttpApiAPPFinance.votesList(page, HttpConstants.PAGE_SIZE, 1, 0, new HttpApiCallBackPageArr<ApiUsersVoterecord>() {
            @Override
    ...
    private void goTop() {
        if (binding.refreshLayout != null) {
            ...
            if (binding.refreshLayout.autoRefresh()) {
                binding.todayProfitRecy.scrollToPosition(0);
