...
public class TreasureChestFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView() {
        TreasureChest_Classification = mParentView.findViewById(R.id.TreasureChest_Classification);
        ...
        TreasureChest_viewPage = mParentView.findViewById(R.id.TreasureChest_viewPage);
        TreasureChest_spot = mParentView.findViewById(R.id.TreasureChest_spot);

        ImageView TreasureChest_choice = mParentView.findViewById(R.id.TreasureChest_choice);
        TreasureChest_choice.setOnClickListener(this);

        TreasureChest_Title = mParentView.findViewById(R.id.TreasureChest_Title);

        TreasureChest_ProgressBar = mParentView.findViewById(R.id.TreasureChest_ProgressBar);
        TreasureChest_Rela = mParentView.findViewById(R.id.TreasureChest_Rela);
        TreasureChest_View = mParentView.findViewById(R.id.TreasureChest_View);
        TreasureChest_Frame = mParentView.findViewById(R.id.TreasureChest_Frame);

        TreasureChest_GiftList = mParentView.findViewById(R.id.TreasureChest_GiftList);
        ...
        TreasureChest_WinRecord = mParentView.findViewById(R.id.TreasureChest_WinRecord);
        TreasureChest_Time = mParentView.findViewById(R.id.TreasureChest_Time);
    }
    ...
    public void getMarquee(List<GameAwardsDTO> retModel) {
        ...
        if (retModel.size() == 0) {
            ...
            for (int i = 0; i < retModel.size(); i++) {
                ...
                if (retModel.get(i).prizeType == 0) {
                    textView.setText("恭喜 " + retModel.get(i).userName + " 开出豪华大奖 " + SpUtil.getInstance().getCoinUnit() + "*" + retModel.get(i).prizeNum);
