...
public class GoodsAdapter1 extends RecyclerView.Adapter<GoodsAdapter1.Holder> {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Holder(LayoutInflater.from(mContext).inflate(R.layout.item_goods1, parent, false));
    }
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (dto.channelId == 1) {
                        ...
                        if (dto.productLinks.startsWith("http")) {
