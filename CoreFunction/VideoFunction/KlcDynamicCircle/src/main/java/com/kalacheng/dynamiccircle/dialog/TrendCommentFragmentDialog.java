...
public class TrendCommentFragmentDialog extends BaseDialogFragment implements View.OnClickListener, OnRefreshListener, OnLoadMoreListener {
    ...
    public void setPosition(int position, String location) {
    ...
    public void getInitView() {
        ...
        adpater.setOnTrendCommentItemClickListener(new OnTrendCommentItemClickListener() {
            ...
            public void onItemClick(ApiUsersVideoComments commentBean) {
                ...
                popwindow.showShadow(false, mRootView.findViewById(R.id.input), 2, commentBean.commentid, false, commentBean.userName);
...
//                });
    ...
    private void getCommentCount() {
        HttpApiAppVideo.getCommentCount(bean.id, new HttpApiCallBack<HttpNone>() {
            @Override
            public void onHttpRet(int code, String msg, HttpNone retModel) {
                if (code == 1 && retModel != null) {
                    mCommentNum = Integer.parseInt(retModel.no_use);
                    tvCommentNum.setText(retModel.no_use + "评论");
                }
            }
        });
    }
    ...
    private void getComment() {
        HttpApiAppVideo.getCommentBasicInfo(page, 10, bean.id, new HttpApiCallBackPageArr<ApiUsersVideoComments>() {
            @Override
...
//                }
            InputPopwindow popwindow = new InputPopwindow(mContext);
            popwindow.showShadow(false, mRootView.findViewById(R.id.input), 1, bean.id, false, "");
            popwindow.setInputSuccessCallBack(new InputPopwindow.InputSuccessCallBack() {
                @Override
                public void Success(ApiUsersVideoComments comments) {
                    insertComment(comments);
            ...
            facepopwindow.showShadow(false, mRootView.findViewById(R.id.input), 1, bean.id, true, "");
