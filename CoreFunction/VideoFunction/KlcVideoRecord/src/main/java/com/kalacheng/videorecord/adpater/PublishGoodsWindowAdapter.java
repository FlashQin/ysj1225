...
public class PublishGoodsWindowAdapter extends RecyclerView.Adapter<PublishGoodsWindowAdapter.LiveGoodsWindowViewHolder> {
    private Context mContext;
    private LiveGoodsWindowCallBack callBack;
    private List<ShopGoodsDTO> mList = new ArrayList<>();

    public PublishGoodsWindowAdapter(Context mContext) {
    ...
    public LiveGoodsWindowViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.publishgoodswindow_itme, null, false);
