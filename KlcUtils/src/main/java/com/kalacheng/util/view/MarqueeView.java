...
public class MarqueeView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        mBackgroundColor = ContextCompat.getColor(mContext, R.color.color_FFFFA000);
        //app:direction=”left” 表示向左滚动，根据自己的需求设定方向；app:isRepeat=”true”
        //是否重复滚动；app:speed=”100” 设置滚动的速度，值越小速度越快，值越大速度越慢，app:startPoint=”end”是文字的起始点。
        ...
        mTextSize = a.getDimension(R.styleable.MarqueeView_textSize, 40);
        mBackgroundColor = a.getColor(R.styleable.MarqueeView_marqueeBackground, ContextCompat.getColor(mContext, R.color.color_FFFFA000));
        ...
        setZOrderOnTop(true);      // 这句不能少 不然有可能SurfaceView会透明
        ...
        public void onDraw() {
            try {
                synchronized (holder) {
                    ...
                    canvas.drawText(margueeString, currentX, centeYLine + dip2px(getContext(), textHeight), mTextPaint);
