...
public class ProgressTextView2 extends TextView {
    ...
    public ProgressTextView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProgressTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStrokeWidth = (int) ta.getDimension(R.styleable.ProgressTextView2_ptv2_stroke_width, 0);
        mProgress = ta.getInteger(R.styleable.ProgressTextView2_ptv2_progress, MAX_PROGRESS);
        ta.recycle();
        init();
    }
