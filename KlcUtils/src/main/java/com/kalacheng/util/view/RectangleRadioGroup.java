...
/**
 * 矩形RadioGroup，实现多行多列布局
 * Created by ysj on 2016/11/18.
 */

public class RectangleRadioGroup extends LinearLayout {
    ...
    public RectangleRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public RectangleRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public List<RadioButton> findRadioButton(ViewGroup group) {
        List<RadioButton> resBtn = new ArrayList<RadioButton>();
        int len = group.getChildCount();
        for (int i = 0; i < len; i++) {
            if (group.getChildAt(i) instanceof RadioButton) {
                resBtn.add((RadioButton) group.getChildAt(i));
            } else if (group.getChildAt(i) instanceof ViewGroup) {
                resBtn.addAll(findRadioButton((ViewGroup) group.getChildAt(i)));
            }
        }
        return resBtn;
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RectangleRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RectangleRadioGroup.LayoutParams;
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RectangleRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RectangleRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == RectangleRadioGroup.this && child instanceof ViewGroup) {
