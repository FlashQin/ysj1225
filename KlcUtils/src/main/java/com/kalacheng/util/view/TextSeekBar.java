...
public class TextSeekBar extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public TextSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        seekbarcolor  = ta.getColor(R.styleable.TextSeekBar_seekbarcolor,context.getResources().getColor(R.color.color_DC92F5));
    ...
    protected void onFinishInflate() {
        ...
        mSeekBar.getThumb().setColorFilter(seekbarcolor, PorterDuff.Mode.SRC_ATOP);//设置滑块颜色
