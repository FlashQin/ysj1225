...
public class ViewPagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void addChild(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mTitles.length; i++) {
            ...
            if (mTitles[i].equals(WordUtil.getString(R.string.main_near))) {
                Drawable drawable = getResources().getDrawable(R.mipmap.icon_triangle);
...
//            MeasureSpec.makeMeasureSpec(widthMeasureSpec, MeasureSpec.EXACTLY)
            textView.measure(mTotalScrollX, heightMeasureSpec);
        }
    }
